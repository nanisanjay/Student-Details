<?php  
 $sql="SELECT * FROM reg WHERE Is_verfied='0'";
...
<ul>
<li id="xyz" class="active" style="background-color:white"> <a href="db.php?nonverified">Non-Verified User</a></li>
<li id="xyz" ><a href="db.php?verified">Verified User</a></li>
<li><a href="db.php?profile">Profile</a></li>
<li>Logout</li>
</ul>
<form action="db.php" method="POST">
<input type="submit" name="nonverify" class="btn btn-primary" value="verify">
